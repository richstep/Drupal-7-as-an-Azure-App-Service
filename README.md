...
### How to Build the Base Docker Image
1. Run `docker build --rm -f Dockerfile -t creg7smg.azurecr.io/drupal7_for_docker:base .`
...
6. Rename `Dockerfile.MAIN.txt` back to `Dockerfile`
7. Edit line 1 of `Dockerfile`. The `FROM` command should reference the base container that you pushed to your Azure container registry. For example:
